...
export default function Signup({ navigation }) {
  return (
    ...
    <View style={styles.container}>
        ...
        <TextInput style={styles.input} placeholder="Your Name" />
        <TextInput style={styles.input} placeholder="Your Name" secureTextEntry={true} />
      ...
      <View style={{flexDirection:'row', justifyContent: 'center', position:'absolute', bottom:10,}}>
        ...
        <Text style={{fontSize: 20, color: "#4c4ef9",fontWeight: 'bold'}}  onPress={() => {navigation.navigate('Login')}}>Login</Text>
      </View>
    </View>
    </ImageBackground>
  );
